...
void rule()
{
	...
	cout<<"Rules:-\n";
	cout<<".The game is for 6 players\n";
	cout<<"First player to reache pount 10 will win
	cout<<"The Bottle is represented in form of a arrow"
	cout<<"Steps"
	cout<<"1.enter your names and age"
	cout<<"2.Enter p to play or q to quit"
	cout<<"you have to choose a ask (truth or dare)";
	cout<<"if the answerer complete the task he/she will get one point "
	cout<<"else the asker will get one point"
	cout<<"To continue the game enter p";
}
		...
		q:
			...
			if(w=='P'||w=='p')
			{
				...
				cout<<asker<<" will ask to "<<answer<<endl;
					...
					{	
						p=obj.points(99);
						string n=obj.searchname(p);
						cout<<n<<"is the winner";
						exit;
					}
					else
					{
